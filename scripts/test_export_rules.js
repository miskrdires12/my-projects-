...
if (headersNoBlood.length === 6 && !headersNoBlood.includes("BloodType")) {
  console.log("PASS: Headers without blood type has 6 columns and NO BloodType.");
} else {
...
if (headersWithBlood.length === 7 && headersWithBlood[5] === "BloodType") {
  console.log("PASS: Headers with blood type has 7 columns and BloodType at index 5.");
} else {
...
if (row1.length === 6 && row1[4] === "251911223344") {
  console.log("PASS: Row 1 matches standard 6 columns.");
} else {
...
if (row2WithBlood.length === 7 && row2WithBlood[5] === "A+") {
  console.log("PASS: Row 2 has 7 columns with exact blood type 'A+'.");
} else {
...
if (row1InBloodBatch.length === 7 && row1InBloodBatch[5] === "") {
