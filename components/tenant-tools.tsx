...
export function TenantTools({
  ...
  return (
    <div className="space-y-4">
      ...
      {maintenanceMode && (
        <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-200 text-xs flex items-center justify-between animate-in fade-in">
      ...
      <div className="flex items-center justify-between pt-2">
        <div>
          ...
          <p className="text-xs text-neutral-400">
            Service credentials, security policies, and workspace data export for <code className="font-mono text-fuchsia-300">/{organizationSlug}</code>.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Tool 1: API Key Generator */}
        <div className="p-5 rounded-3xl bg-[#13131b] border border-white/[0.08] shadow-xl space-y-3 flex flex-col justify-between hover:border-purple-500/30 transition-all">
          ...
          <div className="space-y-2">
            {apiKey ? (
              <div className="space-y-1.5">
                <div className="flex items-center gap-1 bg-white/[0.04] p-2 rounded-xl border border-white/10">
                  <input
                    type="password"
                    readOnly
                    value={apiKey}
                    className="text-[10px] font-mono bg-transparent w-full text-neutral-200 focus:outline-none"
                  />
                  <button
              ...
              <button
                ...
                className="w-full py-2 px-3 rounded-full bg-gradient-to-r from-purple-900/80 to-purple-800/50 border border-purple-500/40 hover:border-purple-400 text-white text-xs font-semibold transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-sm hover:shadow-[0_0_15px_rgba(168,85,247,0.3)]"
              >
        ...
        <div className="p-5 rounded-3xl bg-[#13131b] border border-white/[0.08] shadow-xl space-y-3 flex flex-col justify-between hover:border-purple-500/30 transition-all">
          ...
          <button
            ...
            disabled={exporting}
            className="w-full py-2 px-3 rounded-full bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 text-white text-xs font-semibold transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
          >
        ...
        <div className="p-5 rounded-3xl bg-[#13131b] border border-white/[0.08] shadow-xl space-y-3 flex flex-col justify-between hover:border-purple-500/30 transition-all">
          ...
          <div className="space-y-2.5 text-xs">
            <label className="flex items-center justify-between cursor-pointer">
              <span className="text-[11px] text-neutral-300">Maintenance Mode</span>
              <input
                type="checkbox"
                checked={maintenanceMode}
                onChange={(e) => setMaintenanceMode(e.target.checked)}
                className="h-3.5 w-3.5 accent-fuchsia-500 rounded cursor-pointer"
              />
            </label>
            <label className="flex items-center justify-between cursor-pointer">
              <span className="text-[11px] text-neutral-300">Lock Team Invites</span>
              <input
                type="checkbox"
                checked={lockInvites}
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <span className="text-[11px] text-neutral-300">Enforce 2FA</span>
              <input
                type="checkbox"
                checked={enforce2FA}
        ...
        <div className="p-5 rounded-3xl bg-[#13131b] border border-white/[0.08] shadow-xl space-y-3 flex flex-col justify-between hover:border-purple-500/30 transition-all">
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono text-neutral-400 uppercase">{subscriptionTier}</span>
            </div>
            <p className="text-[11px] text-neutral-400">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-[10px] font-medium text-neutral-300">
                <span>Services</span>
