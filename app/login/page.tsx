    ...
    <div className="w-full max-w-md space-y-6">
      ...
      <div className="p-4 rounded-2xl bg-white border border-neutral-200 space-y-3 shadow-2xs">
        ...
        <div className="space-y-2">
          <button
            ...
            disabled={isLoading}
            className="w-full p-3 rounded-xl bg-black text-white hover:bg-neutral-800 text-left flex items-center justify-between text-xs transition-colors group shadow-xs"
          >
            <div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full p-2.5 rounded-xl bg-neutral-50 hover:bg-neutral-100 border border-neutral-200 text-left flex items-center justify-between text-xs transition-colors group"
          >
            <div>
      ...
      <form onSubmit={handleSubmit} className="p-6 rounded-2xl bg-white border border-neutral-200 space-y-4 shadow-2xs">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full py-2.5 rounded-xl bg-black hover:bg-neutral-800 text-white text-xs font-semibold shadow-xs transition-all flex items-center justify-center gap-2 disabled:opacity-50"
        >
